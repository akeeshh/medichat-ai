...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown('<div class="sb-footer">MediChat v5.5<br>ICT654 - Group 7 - SISTC 2026</div>', unsafe_allow_html=True)
...
if st.session_state.mode == "chat":
    ...
    if not st.session_state.messages:
        if not st.session_state.patient_name:
            # Polished hero section for first-time visitors
            st.markdown(
                '<div class="hero-wrap">'
                '<div class="hero-eyebrow">Live · Testing Stage</div>'
                '<div class="hero-title">Your private clinical AI companion.</div>'
                '<div class="hero-subtitle">Free. Multilingual. Available anytime. Built to give clear, evidence-grounded health guidance, with full transparency about sources and confidence.</div>'
            ...
            st.markdown(
                '<div class="welcome-card" style="padding: 1.6rem 1.8rem;">'
                '<div class="welcome-title" style="font-size: 1.3rem; margin-top: 0;">What should I call you?</div>'
                '<div class="welcome-text" style="font-size: 0.88rem; margin-bottom: 0.9rem;">Sharing your name is optional but helps me personalise our conversation.</div>'
                '</div>',
                unsafe_allow_html=True
            )
