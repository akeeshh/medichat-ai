...
<style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    /* ── Attach Uploader: compact inline button ───────────────────── */
    ...
    .attach-uploader [data-testid="stFileUploader"] section > div {
        background: transparent !important;
        border: none !important;
        padding: 0 !important;
    }
    .attach-uploader [data-testid="stFileUploaderDropzone"] {
        background: transparent !important;
        border: none !important;
        padding: 0 !important;
    }
...
if st.session_state.mode == "chat":
    ...
    # ── Upload + Clear row (outside form — file_uploader can't be in st.form) ──
    bc_up, bc_clear = st.columns([1.1, 1.3])
    with bc_up:
