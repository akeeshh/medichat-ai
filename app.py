...
def medichat_rag_stream(question, all_messages, lang_instruction="", patient_name="", pdf_context="", image_context=""):
    ...
    system = (
        ...
        "Examples of WRONG (turn 5+): 'Hi there. About your vitamin D...' \n"
        "Examples of RIGHT (turn 5+): 'About your vitamin D...' or 'Good question.' or 'For something like that...' or just dive into the answer.\n\n"
