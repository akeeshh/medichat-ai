...
<style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    /* COMPACT UPLOADER: minimal attach button, hide all hint text until file is dropped */
    ...
    /* Hide the "Drag and drop file here" text and "Limit 200MB · JPG, JPEG, PNG, PDF" hint */
    .compact-uploader [data-testid="stFileUploader"] section > div:first-child > span,
    .compact-uploader [data-testid="stFileUploaderDropzoneInstructions"] {
        display: none !important;
    }
    .compact-uploader [data-testid="stFileUploaderDropzoneInstructions"] small {
        display: none !important;
    }
    /* Restyle the Browse files button to be a slim "+ Attach" affordance */
    ...
    /* Show format hint only when an INVALID file is dropped (Streamlit shows error) */
