...
<style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    /* COMPACT UPLOADER: hide ALL dropzone UI, leave only a clean attach button */
    ...
    /* Hide the dropzone area and ALL its children EXCEPT the button */
    .compact-uploader [data-testid="stFileUploader"] section > div:first-child {
        display: none !important;
    }
    ...
    .compact-uploader [data-testid="stFileUploaderDropzone"]:hover {
        background: var(--sage-50) !important;
        border-color: var(--sage-500) !important;
    }
    /* Hide ALL hint text inside the dropzone */
    .compact-uploader [data-testid="stFileUploaderDropzoneInstructions"],
    .compact-uploader [data-testid="stFileUploaderDropzoneInstructions"] *,
    .compact-uploader [data-testid="stFileUploaderDropzone"] small,
    .compact-uploader [data-testid="stFileUploaderDropzone"] span {
        display: none !important;
    }
    /* Restyle the Browse files button as the only visible attach affordance */
    .compact-uploader [data-testid="stFileUploaderDropzone"] button {
        background: transparent !important;
        border: none !important;
        color: var(--sage-700) !important;
    ...
    /* Replace button text "Browse files" with our custom text */
    .compact-uploader [data-testid="stFileUploaderDropzone"] button p,
    .compact-uploader [data-testid="stFileUploaderDropzone"] button span,
    .compact-uploader [data-testid="stFileUploaderDropzone"] button div {
        display: none !important;
    }
    .compact-uploader [data-testid="stFileUploaderDropzone"] button::before {
        content: "📎  Attach a medical image or PDF";
        display: inline-block !important;
        color: var(--sage-700);
        font-size: 0.88rem;
        font-weight: 500;
    }
    /* When a file is uploaded, this row shows the filename + X button - keep visible */
    .compact-uploader [data-testid="stFileUploader"] [data-testid="stFileUploaderFile"] {
        display: flex !important;
    }
    /* Format hint shown via Streamlit error when invalid file is dropped */
    .compact-uploader [data-testid="stAlert"] {
...
if st.session_state.mode == "chat":
    ...
    # File uploader (compact mode, hidden hint text via CSS class)
