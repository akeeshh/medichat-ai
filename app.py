...
<style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    /* ── ATTACH UPLOADER: compact inline button, no static help text ── */
    /* Hide "Limit 200MB per file • JPG, JPEG, PNG, PDF" static text */
    [data-testid="stFileUploaderDropzoneInstructions"] small,
    [data-testid="stFileUploader"] section > div > small,
    [data-testid="stFileUploader"] > label + div small {
        display: none !important;
    }
    /* Hide the drag-drop instruction paragraph, keep only the Browse button */
    [data-testid="stFileUploaderDropzoneInstructions"] > div:first-child {
        display: none !important;
    }

    .attach-uploader [data-testid="stFileUploader"] section {
        padding: 0 !important;
        background: transparent !important;
        border: none !important;
        min-height: 0 !important;
    }
    .attach-uploader [data-testid="stFileUploader"] button {
        background: white !important;
        color: var(--sage-700) !important;
        border: 1px solid var(--sage-100) !important;
    ...
    .attach-uploader [data-testid="stFileUploader"] button:hover {
        background: var(--sage-50) !important;
        border-color: var(--sage-300) !important;
        transform: translateY(-1px) !important;
    }
    /* Keep error/validation alert messages visible (wrong file type etc.) */
...
if st.session_state.mode == "chat":
    ...
    # ── Unified button row: [📎 Attach] [Send to MediChat] [Clear] ─────
    bc_up, bc_send, bc_clear = st.columns([1.4, 2.3, 1.8])
